...
namespace uiohook {
struct target_display { uint32_t id{}; std::string label; };
struct target_application { std::string id; std::string label; };
struct target_window { std::string application_id; uint64_t id{}; std::string label; };
void start();
void stop();
