...
- League Game Report collection now uploads its privacy-safe payload to Handscheck and opens the hosted web report after upload; the embedded local recap, export, and plugin-side Riot enrichment have been removed.
