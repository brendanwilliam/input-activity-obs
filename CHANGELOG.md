...
- Dashboard intensity labels now shrink to fit narrow cards, and live-key displays label standard QWERTY, Command, arrow, navigation, and keypad keys instead of showing an unknown-key marker.
